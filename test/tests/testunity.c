...
void testFloatPrinting(void)
{
    ...
    TEST_IGNORE();
#elif defined(UNITY_INCLUDE_DOUBLE)
    TEST_ASSERT_EQUAL_PRINT_FLOATING("7.8125e-03",     0.0078125f);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("1.40129846e-45", 1.401298464e-45f);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("1.17549435e-38", 1.175494351e-38f);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("5.0000005e-07",  0.00000050000005f);
    ...
    TEST_ASSERT_EQUAL_PRINT_FLOATING("10.0",         10.0f);
    ...
    TEST_ASSERT_EQUAL_PRINT_FLOATING("0.9765625", 0.9765625f); /* Rounds last digit, at 6 decimals */
#endif
}
...
void testDoublePrinting(void)
{
    ...
    TEST_IGNORE();
#else
    TEST_ASSERT_EQUAL_PRINT_FLOATING("4.94065646e-324",      5e-324); /* Smallest sub-normal double */
    TEST_ASSERT_EQUAL_PRINT_FLOATING("2.22507386e-308",      2.2250738585072014e-308);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("1.0e-02",           0.009999999996);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("0.1",               0.1);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("0.1004695",        0.10046949999999999);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("4294967294.999999", 4294967294.999999);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("4294967295.0",      4294967294.9999995);
    ...
    TEST_ASSERT_EQUAL_PRINT_FLOATING("-0.1004695",        -0.10046949999999999);
    TEST_ASSERT_EQUAL_PRINT_FLOATING("-4.2949673e+09",     -4294967295.999999);
